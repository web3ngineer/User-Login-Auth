...
function Footer() {
  ...
  return (
    <footer className='bg-white border-y'>
      <div className='max-w-screen-xl px-4 py-6 mx-auto lg:px-8'>
        <div className='py-6 md:flex md:justify-between'>
            <div className='pb-6 mx-4 md:pb-0'>
        ...
        <div className=' sm:flex sm:items-center sm:justify-between'>
          <p className="mx-4 text-sm sm:text-center">© Copyright 2023. All rights reserved.</p>
          <div className='flex justify-center mx-4 mt-6 space-x-6 sm:mt-0'>
