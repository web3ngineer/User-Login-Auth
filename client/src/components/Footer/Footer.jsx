    ...
    <footer className='bg-white border-y'>
      <div className='px-4 py-6 lg:px-8 mx-auto max-w-screen-xl'>
        <div className='md:flex md:justify-between py-6'>
            ...
            <div className='mx-4 grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3'>
              <div>
        ...
        <div className=' sm:flex sm:items-center sm:justify-between'>
          <p className=" text-sm mx-4 sm:text-center">© Copyright 2023. All rights reserved.</p>
          <div className='flex mx-4 mt-6 space-x-6 justify-center sm:mt-0'>
